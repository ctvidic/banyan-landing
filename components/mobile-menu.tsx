        ...
        <div className="flex flex-col gap-6 mt-10">
          ...
          {process.env.NEXT_PUBLIC_ENABLE_BILL_NEGOTIATOR === 'true' && (
            <Link
              ...
              className="text-emerald-700 bg-emerald-50 px-4 py-2.5 rounded-lg font-medium text-center border border-emerald-200 hover:bg-emerald-100 transition-colors flex items-center justify-center gap-2"
              onClick={() => setOpen(false)}
            >
